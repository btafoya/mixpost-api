...
use Inovector\Mixpost\Database\Factories\PostFactory as MixpostPostFactory;

/**
 * Wrapper factory for Post model to satisfy Laravel's factory discovery.
 *
 ...
 */
class PostFactory extends MixpostPostFactory
{
    // Inherits all behavior from Mixpost's PostFactory
}
